...
def evaluate_and_save(test_dataset, output_file, pattern_map):
    ...
    for idx, item in enumerate(test_dataset):
        ...
        solution_text = f"Predicted option: {predicted_answer} | Trace: {trace.generate_report().replace(chr(10), ' | ')}"
...
if __name__ == "__main__":
    ...
    evaluate_and_save(test_dataset, 'report and output/output.csv', pattern_map)
